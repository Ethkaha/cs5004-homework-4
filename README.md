...
My favorite part was building and testing the formatter pipeline (pretty, JSON, XML, and CSV) and seeing the same data represented cleanly in multiple output formats.

(Optional) How would you improve the assignment?

I would add one small sample XML fixture and one sample CLI run in the prompt so students can validate expected structure more quickly while still implementing all core logic themselves.
